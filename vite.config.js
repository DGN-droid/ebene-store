...
const videoFiles = ['celineboutique3D.mp4', 'parfum3D.mp4', 'parfum2D.mp4', 'Robe.mp4', 'robe3D.mp4', 'veste.mp4', 'sac.mp4'];
...
export default defineConfig({
  ...
  build: {
    rollupOptions: {
      input: { accueil: 'index.html', boutique: 'boutique.html', produit: 'produit.html', panier: 'panier.html', contact: 'contact.html' }
    }
  }
});
